...
<div class="notice--success">
  <h4><i class="fas fa-paper-plane"></i> Application Process</h4>
  <p>If you are interested in working with us, please send an email to <strong>Prof. Pandarasamy Arjunan</strong>.</p>
  
  <p><strong>Please include the following:</strong></p>
  <ol>
    <li><strong>Subject Line:</strong> Use a clear subject (e.g., <em>"Application for Project Staff - [Your Name]"</em>).</li>
    <li><strong>CV/Resume:</strong> Highlighting education and skills.</li>
    <li><strong>Portfolio:</strong> Link to GitHub or past projects.</li>
    <li><strong>Statement:</strong> Brief explanation of your interest.</li>
  </ol>
  
  <p style="text-align: center; margin-top: 20px;">
    <a href="mailto:samy@iisc.ac.in" class="btn btn--inverse btn--large">
