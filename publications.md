...
* **Longitudinal thermal imaging for scalable non-residential HVAC and occupant behaviour characterization**
    * Ramani, Vasantha, Martin, Miguel, Arjunan, Pandarasamy, Chong, Adrian, Poolla, Kameshwar, and Miller, Clayton
    * *Energy and Buildings 2023*

* **Paddy Doctor: A Visual Image Dataset for Automated Paddy Disease Classification and Benchmarking**
    * Kiruba, Briskline, and Arjunan, Pandarasamy
...
* **The way forward for building energy benchmarking in India**
    * Kalluri, Balaji, Dhariwal, Jay, Arjunan, Pandarasamy, Anand, Prashant, and Deb, Chirag
    * *In Proceedings of the 9th ACM International Conference on Systems for Energy-Efficient Buildings, Cities, and Transportation 2022*

* **Trimming outliers using trees: winning solution of the large-scale energy anomaly detection (LEAD) competition**
    * Fu, Chun, Arjunan, Pandarasamy, and Miller, Clayton
    * *In Proceedings of the 9th ACM International Conference on Systems for Energy-Efficient Buildings, Cities, and Transportation 2022*

* **eptk: energy prediction toolkit**
    * Prabhu, Hardik, and Arjunan, Pandarasamy
    * *In Proceedings of the 9th ACM International Conference on Systems for Energy-Efficient Buildings, Cities, and Transportation 2022*
